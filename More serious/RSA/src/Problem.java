            ...
            if (Character.isDigit(str.charAt(i))) {
                ...
                if (numbers.size() >= 2) {
                    ...
                    while (numbers.size() >= 2 && sign.get(sign.size() - 1) >= temp) {
                        if (sign.get(sign.size() - 1) == 4) {
//                            numbers.add(div(numbers.get(numbers.size() - 1), numbers.get(numbers.size() - 2)));
                            numbers.remove(numbers.size() - 2);
                            numbers.remove(numbers.size() - 2);
                            sign.remove(sign.size() - 1);
                        }  else if (sign.get(sign.size() - 1) == 3) {
                            ...
                            numbers.remove(numbers.size() - 2);
                            sign.remove(sign.size() - 1);
                        } else if (sign.get(sign.size() - 1) == 5) {
                            break;
                        }
                        if (temp == 0 && sign.size() > 0 && sign.get(sign.size() - 1) == 5) {
                            sign.remove(sign.size() - 1);
                        }
                    }
                }
